...
const Faction = () => {
  return (
    ...
    <div className="w-full h-fit px-8 lg:px-36 md:p-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <Link to="/history/gigerianus"  className='faction-card hover:shadow-[0px_0px_89px_0px_#4c51bf]'>
      ...
      <Link to="/history/humanos" className='faction-card hover:shadow-[0px_0px_89px_0px_#D9002E]'>
        <div className='faction-blur'>
      ...
      <Link to="/history/venyator" className='faction-card hover:shadow-[0px_0px_89px_0px_#fff]'>
        <div className='faction-blur'>
          <p>Venyator</p>
        </div>
