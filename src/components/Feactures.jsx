    ...
    <div className="w-full h-fit p-8 lg:p-36 md:p-24">
      ...
      <div className="flex justify-between flex-col-reverse lg:flex-row mt-20 lg:mt-40">
        <div className="w-full lg:w-1/2 lg:mr-10 text-white flex flex-col lg:items-end ">
          <h2 className="mb-3 font-bold lg:text-[36px] text-3xl">Comienzo de la Aventura</h2>
          <p className="mb-10 lg:text-right">
          En Agoreios, somos apasionados por los juegos de mesa y por ofrecer experiencias únicas y emocionantes a nuestros jugadores. Nuestro equipo está dedicado a crear mundos imaginativos donde la estrategia y la diversión se encuentran.
          <br /><br />
          Desde el diseño de miniaturas hasta la elaboración de reglas y escenarios, cada aspecto de Tactical Encounters está cuidadosamente diseñado para brindar una experiencia de juego inolvidable. 
          </p>
